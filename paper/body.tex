...
the access points. These are termed \emph{green} spaces, not \emph{public} spaces: OSM
...
reading a tidy grid as automatically resilient: in this sample it is the less ordered,
