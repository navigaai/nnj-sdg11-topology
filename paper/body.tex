...
paradox driven by the same scale the fixed effects absorb. Two qualifications
...
and the headline morphology effects survive their inclusion, which rules those four
out as the drivers. But population and built density, land-use mix, park-level size
...
longer street segments predict greater resilience. A third, orientation entropy, is
