...
(equal-area) extent. These five carry the headline analysis; three further cities
(Singapore, Nairobi and Vienna) are added later as an external-validity test
(Section~\ref{sec:results}).
