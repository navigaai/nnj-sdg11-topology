...
boundaries), on the five-city core, gives an almost identical within-city
correlation ($\rho=+0.35$, $p<10^{-76}$). So the topological signal is not an artefact of weighting locations
