...
circuitous routing predict greater resilience, and both survive a wild cluster
bootstrap and spatial-error and spatial-lag models---while higher orientation entropy
predicts less resilience and is strong in the spatial models but less certain across
cities. The association is consistent rather than proven causal, the study
